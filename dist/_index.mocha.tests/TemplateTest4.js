...
var TEMPLATE_FILE = path_1.default.join(__dirname, 'TemplateTest4.input.hbs');
var EXPECTED_FILE = path_1.default.join(__dirname, 'TemplateTest4.expected.hbs');
var Test = AssertionTest_1.default()
    .describe('template test 4')
